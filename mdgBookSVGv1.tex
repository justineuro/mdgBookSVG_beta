...
\section{Introduction
	\footnote{The information contained in the introduction were culled from the following online resources:
	%\hyperlink{https://en.wikipedia.org/w/index.php?title=Musikalisches\_W\%C3\%BCrfelspiel\&oldid=787418377}{{\tt Wikipedia: Musikalisches W\"{u}rferspiel}} 
	\citet{wiki_mw2017},
...
\begin{table}[H]
	...
	\begin{tabular}{c}
		\centering
		\includegraphics[clip=true,trim=0.90in 7.75in 1.25in 1.00in,scale=0.90]{0TAB1-1}
	\end{tabular}
...
\begin{figure}[H]
	...
	\input{abcmdg-k516f-bymeas001.pdf_tex}
...
\begin{figure}[H]
	\centering
	\def\svgwidth{0.975\columnwidth}
	\input{abcmdg-k516f-bymeas002.pdf_tex}
...
\begin{figure}[H]
	\centering
	\def\svgwidth{0.975\columnwidth}
	\input{abcmdg-k516f-bymeas003.pdf_tex}
...
\begin{figure}[H]
	\centering
	\def\svgwidth{0.975\columnwidth}
	\input{abcmdg-k516f-bymeas004.pdf_tex}
...
% Ghostscipt
% \LaTeX
% John henrry Fogarty - generate cover
...
\begin{itemize}
	\item  \hyperlink{https://marian-aldenhoevel.de/mozart/}{Mozart} - A site maintained by Marian Aldenh\"{o}vel allows the visitor to generate a MDG (user-specified or randomly-generated) and the corresponding audio ({\tt midi, wav}) and image file ({\tt pdf, png}) based on {\em Musikalisches W\"{u}rferspiel, K.\ 516f}.
	
	\item \hyperlink{https://opus-infinity.org/}{Opus Infinity} - Collaborative work of Robbert Harms, Hein Moors, and Suus van Petegem whose goal is to unravel the mystery behind the tables used for generating MDGs.  Site visitors can generated MDGs based on works of Kirnberger, Mozart, Stadler/Haydn), and Bach.  Corresponding audio files ({\tt mid, ogg, wav,} and/or {\tt mp3})
	...
	\item  \hyperlink{http://sunsite.univie.ac.at/Mozart/dice/}{Mozart} - A site maintained by John Chuang that allows the site visitor to generate MDGs based on the work of Stadler/Haydn.
 	...
 	\item \hyperref{(http://www.asahi-net.or.jp/\~rb5h-ngc/e/k516f.htm}{}{}{``Mozart - Musical Game in C K. 516f*(http://www.asahi-net.or.jp/\~rb5h-ngc/e/k516f.htm)"},	Mozart Studies Online - The site of Hideo Noguchi that offers an explanation linking {\em Musikalisches W\"{u}rferspiel, K.\ 516f}, {\em K.\ 294d, \mbox{ and } K.\ Anh.\ C 30.01)}.
